		...
		if(!!navigator.geolocation) {
			...
			navigator.geolocation.getCurrentPosition(function(position) {
			    ...
			    var marker = new google.maps.Marker({
						 ...
						 map: map,
						 title: 'You are here',
						 icon: mapsData.theme_path+'/images/maps/you-are-here.png',
						 zIndex: 999999999
					 });
    	...
    	// console.log(mapsData.properties);
         $.each(mapsData.properties, function(index, locations){
			...
			/* ===================================================================== */
			 ...
			 iconStandard = mapsData.theme_path+'/images/maps/cottage-pin.png';
			...
			google.maps.event.addListener(marker, 'mouseover', function() {
				this.setIcon(mapsData.theme_path+'/images/maps/cottage-hover-pin.png');
			});
			google.maps.event.addListener(marker, 'mouseout', function() {
				this.setIcon(mapsData.theme_path+'/images/maps/cottage-pin.png');
			});
					...
					return function() {
						...
						box = '<div class="rem-box-maps">' +
								  ...
								  '<div class="details">' +
									  ...
									  '<tr>' +
									  '<td><span class="label label-primary"><span class="fa fa-home"></span> '+ locations.info.room +'</span></td>' +
									  '<td><span class="label label-primary"><span class="fa fa-bed"></span> '+ locations.info.bedRoom +'</span></td>' +
									  '<td><span class="label label-primary"><span class="fa fa-bath"></span> '+ locations.info.bathRoom +'</span></td>' +
									  '<td><span class="label label-primary"><span class="fa fa-arrows-alt"></span> '+ locations.info.perimeter +'</span></td>' +
									  '</tr>' +
									  '</table>' +
								  '</div>' + 
							  '</div>';

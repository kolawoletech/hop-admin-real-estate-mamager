    ...
    switch ($field['type']) {
        ...
        case 'textarea': ?>
            ...
            <div class="form-group">
                <label for="<?php echo $field['name']; ?>" class="col-sm-4 control-label"><?php echo $field['title']; ?></label>
                <div class="col-sm-8">
                    <textarea name="<?php echo $field['name']; ?>" class="form-control" id="<?php echo $field['name']; ?>"><?php echo stripcslashes($field_value); ?></textarea>
                    <span class="help-block"><?php echo $field['help']; ?></span>
                </div>
            </div>
            <?php break;
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <button class="btn btn-info btn-sm upload_image_button" data-title="<?php _e( 'Image', 'real-estate-manager' ); ?>"
